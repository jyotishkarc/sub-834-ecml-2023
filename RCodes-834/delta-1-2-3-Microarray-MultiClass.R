########## Implementation of the proposed classifiers for datasets from the Microarray database
...
## Path for the dataset 'GSE89'. Make the next line a comment if not intended to run.
path <- paste0("Datasets/MA-GSE89/bladderGSE89.csv")

## Path for the dataset 'GSE1577'. Uncomment the next line if intended to run.
# path <- paste0("Datasets/MA-GSE1577/LL_GSE1577_2razreda.csv")
