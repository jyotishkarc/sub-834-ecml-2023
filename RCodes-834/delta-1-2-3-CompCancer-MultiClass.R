########## Implementation of the proposed classifiers for datasets from the CompCancer database
...
## Path for the dataset 'Golub-1999-v2'. Make the next line a comment if not intended to run.
path <- paste0("Datasets/CC-Golub-1999-v2/golub-1999-v2_database.xlsx")

## Path for the dataset 'Gordon-2002'. Uncomment the next line if intended to run.
# path <- paste0("Datasets/CC-Gordon-2002/gordon-2002_database.xlsx")
